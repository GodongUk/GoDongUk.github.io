...
<html><head>
  ...
  <style> * {padding:0; margin:0; }
    body {font-family: Verdana, sans-seif; font-size:0.8em}
    ...
    .id_form{width:50px;} .label_form{dosplay: inline-block; width:55px; height:14px; color:red;padding:5px;}
  ...
  </style><title>로그인 실습</title></head>
  <jsp:useBean id="dto" cclass="studpkg.StudDTO"/>
...
<body><header><h2>실습을 환영합니다.</h2></header>
  ...
  <section>
    ...
    </fieldset></section><footer><p>%copy; 2021 Made by Korea. All right reserved.</p></footer></body></html>
